...
def home(request):
    ...
    return render(request, 'privetchat/home.html', context)
...
def createRoom(request):
    ...
    if request.method == 'POST':
        ...
        return redirect('privetchat:home')
...
def topicsPage(request):
    ...
    return render(request, 'privetchat/topics.html', {'topics': topics})


def activityPage(request):
    room_messages = Message.objects.all()
    return render(request, 'privetchat/activity.html', {'room_messages': room_messages})
