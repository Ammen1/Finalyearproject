...
SECRET_KEY = 'django-insecure-z*gahm$=#0**&v8=^sro=dfns-e=j&#f2wr&f*uba2@!w9!_7s'
...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": " Hospital Recomendatios",

    # # Logo to use for your site, must be present in static files, used for brand on top left
    # "site_logo": "image/after.png",
    ...
    "welcome_sign": "Welcome to the Hospital Recomendations",

    # Copyright on the footer
    "copyright": "IT Group one",
    ...
    "custom_links": {
        "Notifications": [{
            ...
            "permissions": ["Doctors.view_Notificatios"]
        }]
    },
    ...
    "changeform_format_overrides": {"auth.user": "", "auth.group": "vertical_tabs"},
